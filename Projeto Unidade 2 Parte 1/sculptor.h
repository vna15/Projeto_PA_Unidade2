...
public:
   ...
   * @param ycenter é a coordenada do centro da elipsoide na direção x.
   * @param zcenter é a coordenada do centro da elipsoide na direção x.
  ...
  /**
   * @brief cutEllipsoid é a função que inativa um objeto na forma de um elipsoide.
   * @details Dada as coordenadas do centro da elipsoide e os raios em cada direção, o obejteo é desativado.
   */
  void cutEllipsoid(int xcenter, int ycenter, int zcenter, int rx, int ry, int rz);
  /**
   * @brief writeOFF é a função que cria um arquivo.
   * @param filename é o nome do arquivo a ser criado.
   * @details Essa função serve para o usuário criar um arquivo .OFF contém os elementos necessários para ser rodado em ferramentas de visualização.
   */
